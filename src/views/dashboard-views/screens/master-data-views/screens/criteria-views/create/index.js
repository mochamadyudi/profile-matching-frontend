	...
	return (
		<React.Fragment>
			<HeroComponents
				loading={loading}
				name={"Create"}
				positionName={['Master Data','Criteria']}
				thumbnail={null}
				extra={<>
					<ButtonPermission
						permission={['admin']}
				...
				<ContainerTailwind>
					<Card bordered={false}>
						...
						>
							<Row gutter={24}>
								<Col span={12}>
									<Form.Item name={'name'} label={'Identifier'} rules={rules.name} hasFeedback>
										<Input placeholder={'input your Identifier'} autoComplete={'off'}/>
									</Form.Item>
								</Col>
								<Col span={12}>
									<Form.Item name={['data','name']} label={'Display Name'} rules={rules.name} hasFeedback>
										<Input placeholder={'input your category name'} autoComplete={'off'}/>
									</Form.Item>
								</Col>
								<Col span={24}>
									<Form.Item name={['data','description']} label={'Description'} hasFeedback rules={rules.description}>
										<Input.TextArea
