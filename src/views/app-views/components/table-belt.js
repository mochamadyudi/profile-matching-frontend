...
function TableBelt(props){
    ...
    const [ params, setParams] = useState(()=> {
        ...
        return {
            page:ToNumber(page,props?.params?.page ?? 1),
            limit: ToNumber(limit,props?.params?.limit ?? 10)
        }
    })
    ...
    return (
        <div className="w-full">
            <Card title={title} extra={<ExtraComponent/>}>
                <Table
...
TableBelt.defaultProps = {
    title:null,
    pagination: false
}
export default TableBelt